        ...
        //console.log(tx.blockhash);
              ...
              lib.get_block(tx.blockhash, function(block){
                if (block) {
                      ...
                      //console.log("there should be vin");
                      //console.log(tx.vin);
                      
                    
                      //console.log("there should be vout");  
                      //  console.log(tx.vout);
                      lib.calculate_total(tx.vout, function(total){
                            var newTx = new Tx({
                              txid: txid,
                              vin: tx.vin,
                              vout: tx.vout,
        ...
        lib.get_connectioncount(function (connections) {
          Stats.update({coin: coin}, {
            ...
            connections: connections,
              ...
              console.log("updated coin: " + coin + " count: " + count + " supply: "+supply);
            return cb(true);
          });
        });
      }, count);
